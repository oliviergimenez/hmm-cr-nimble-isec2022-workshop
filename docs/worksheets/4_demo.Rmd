...
library(here)
library(nimble)
setwd('/Users/oliviergimenez/Dropbox/OG/GITHUB/bayesian-cr-workshop/worksheets')
```
...
Run nimble. 
```{r, echo = TRUE, fig.width = 7.5, fig.asp = 0.618, dev = "svg", warning=FALSE, message=FALSE, fig.align="center"}
Cmcmc$run(10000)
